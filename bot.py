...
def is_premium(user_id):
    """Check if user is the Admin or listed in premium.txt"""
    if user_id == ADMIN_ID:
        return True
...
🤖 <b>Bot By: <a href="tg://user?id=5248903529">ㅤㅤP.o.Riot🍄</a></b>"""
...
🤖 <b>Bot By: <a href="tg://user?id=5541778617">ㅤㅤP.o.Riot🍄</a></b>"""
